...
\end{equation}
denote the Pauli matrices, and $\alpha_{jk}$ denotes the angle of the edge between the $j$ and $k$th site relative to the $x$ axis \cite{Loring}.%(see second slide of \verb|Loring_slides.pdf| in \verb|related_papers| directory).
